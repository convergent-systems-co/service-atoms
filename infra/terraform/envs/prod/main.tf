...
#   - Zone → DNS → Edit  on the service-atoms.com zone
...
module "pages_project" {
  ...
  project_name          = "service-atoms"
  production_branch     = "main"
  custom_domain         = "service-atoms.com"
  zone_id               = var.zone_id
}
...
variable "zone_id" {
  description = "Cloudflare zone ID for service-atoms.com."
  type        = string
}
